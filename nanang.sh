clear
echo
echo "MASUKAN USERNAME AND PASSWORD"
sleep 3
python2 userpass.py
echo
clear
...
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "[●] • author   : Nanang/Entup                  [●]" | lolcat
echo "[●] • github   : https://github.com/AscendoHack[●]" | lolcat
echo "[●] • youtube  : ENTUP ID                      [●]" | lolcat
echo "[●] • facebook : Ascendo ID                    [●]" | lolcat
echo "[●] • support  : HackingAttack/AscendoHack/DDC [●]" | lolcat
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "[●]      •JANGAN LUPA SUBSCRIBE ENTUP ID•      [●]" | lolcat
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "
┏━━━━━┫{menu dark fb}┣━━━━━┓
┃
...
if [ $bro = 99 ] || [ $bro = 99 ]
then
echo $cyan  "THANKS BOSKU DAN JANGAN LUPA SUBSCRIBE"
sleep 1
exit
fi
